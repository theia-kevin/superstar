...
?>
<div class="h-[1500px] xl:h-[1000px] bg-no-repeat bg-cover bg-center flex items-center mb-[100px] xl:mb-[200px]" style="background-image: url('<?php echo get_field('recent_news_background', 'option')['url']; ?>');">
            ...
            foreach ($recent_newses as $recent_news) {
                ...
                <div class="col-span-12 xl:col-span-4 text-center">
                    <a href="<?php echo get_permalink($recent_news['ID']); ?>">
                        <img class="object-contain mx-auto" src="<?php echo get_the_post_thumbnail_url($recent_news['ID']); ?>" alt="">
                    </a>
