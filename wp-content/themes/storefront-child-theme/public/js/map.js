...
/*!******************************************************************!*\
  ...
  \******************************************************************/
/*! namespace exports */
/*! export DEFAULT_ID [provided] [no usage info] [missing usage info prevents renaming] */
...
var googleMapLoader = new _googlemaps_js_api_loader__WEBPACK_IMPORTED_MODULE_0__.Loader({
  ...
  var coordinates = {
    lat: parseFloat(window.wp_obj.google_map_latitude),
    lng: parseFloat(window.wp_obj.google_map_longitude)
  };
