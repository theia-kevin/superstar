            ...
            <div class="grid grid-cols-11 w-full">
                ...
                <div class="col-span-3 pt-[30px] animate__animated animate__zoomInDown">
                    <a href="<?php echo home_url('/'); ?>">
                        <img class="object-contain mx-auto transition-all duration-500 hover:transform hover:scale-125" src="<?php echo getCustomLogo()[0]; ?>" alt="">
                    </a>
                </div>
                <div class="col-span-4 flex justify-between pt-[90px]">
    ...
    <div class="relative z-50 block xl:hidden h-[200px] bg-no-repeat bg-cover bg-left-bottom" style="background-image: url('<?php echo get_field('header_background',
        ...
        <div class="container mx-auto px-4 grid grid-cols-3">
            ...
            <a class="flex justify-center" href="<?php echo home_url('/'); ?>">
                <img class="object-contain h-[100px] self-center my-[15px] transition-all duration-500 hover:transform hover:scale-125" src="<?php echo getCustomLogo()[0]; ?>" alt="">
            </a>
            <div class="cursor-pointer flex items-center justify-end" @click.stop="sidebarOpen = true">
                <svg class="h-10 w-10 text-white transition-all duration-500 hover:text-yellow-01 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div x-show="sidebarOpen" style="display: none;">
            <div class="fixed inset-0 flex z-40">
                <div class="fixed inset-0" @click="sidebarOpen = false" x-show="sidebarOpen" x-transition:enter="transition-opacity ease-linear duration-500" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-linear duration-500" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                    <div class="absolute inset-0 bg-purple-01 opacity-75"></div>
                </div>
                <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-blue-02" x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-500 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-500 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full">
